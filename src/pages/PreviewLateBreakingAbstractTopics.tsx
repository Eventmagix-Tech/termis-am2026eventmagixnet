...
const PreviewLateBreakingAbstractTopics = () => (
  <div className="min-h-screen bg-background">
    <SEOHead title="Late Breaking Abstract Topics" description="Preview: Late breaking abstract topics." noindex={true} />
    <Header />
...
export default PreviewLateBreakingAbstractTopics;

...
const PreviewLateBreakingAbstractSubmission = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title="Late Breaking Abstract Submission"
        description="Preview: Late breaking abstract submission instructions."
        noindex={true}
      />
      <Header />
...
export default PreviewLateBreakingAbstractSubmission;

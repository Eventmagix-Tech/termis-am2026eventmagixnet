...
const importantDates = [
  ...
  "Completed applications and all supporting materials must be submitted through the official submission form no later than August 28, 2026.",
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="Apply to the TERMIS-AM 2026 Business Pitch Competition. Submit your tissue engineering or regenerative medicine innovation by August 28, 2026."
      />
      <Header />
      ...
      <main id="main" className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="text-lg text-foreground space-y-4 mb-6">
          ...
          <p>
            If so, we invite you to apply to the <strong>TERMIS-Americas (TERMIS-AM) 2026 Business Pitch Competition (BPC)</strong> by submitting your application until August 28, 2026.
          </p>
        </div>

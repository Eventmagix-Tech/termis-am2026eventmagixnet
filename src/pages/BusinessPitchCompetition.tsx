  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main id="main" className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <h3 className="text-xl font-bold text-primary mt-10 mb-4">Finalist Pitch Presentation Format & Timing</h3>
        ...
        <h3 className="text-xl font-bold text-primary mt-10 mb-4">Eligibility Requirements</h3>
        ...
        <h3 className="text-xl font-bold text-primary mt-10 mb-4">Important Confidentiality Notice</h3>
        ...
        <h3 className="text-xl font-bold text-primary mt-10 mb-4">Important Dates & Events</h3>
        <ul className="list-disc ml-8 space-y-2 text-lg text-foreground">
